...
val logger = LoggerFactory.getLogger("loadGenbankRnaFeatures")

import org.apache.log4j.{ Level, Logger }
Logger.getLogger("loadGenbankRnaFeatures").setLevel(Level.INFO)
...
val features = bac.loadGenbankRnaFeatures(inputPath.get)

logger.info("Saving RNA sequence features to output path %s ...".format(outputPath.get))
