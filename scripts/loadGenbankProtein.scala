...
val logger = LoggerFactory.getLogger("loadGenbankProtein")

import org.apache.log4j.{ Level, Logger }
Logger.getLogger("loadGenbankProtein").setLevel(Level.INFO)
...
val sequences = bac.loadGenbankProtein(inputPath.get)
